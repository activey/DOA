...
public class FeedbackLabel extends Label {
     ...
     * @param text      The custom text to show when the FormComponent has a
     *                  FeedbackMessage
     */
     ...
     * @param iModel    The custom model to show when the {@link FormComponent} has a
     *                  FeedbackMessage
     */
    ...
    protected String getCssClass(FeedbackMessage message) {
        return "feedbacklabel " + message.getLevelAsString();
    }

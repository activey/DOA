...
import com.olender.webapp.admin.pages.sections.contact.ContactSectionDataPanel;
import com.olender.webapp.admin.pages.sections.contact.GisDataPanel;
import com.olender.webapp.components.OlenderTabbedPanel;

public class ContactSectionDetailsDecorator extends
	...
	protected void collectTabs(IModel<IDocument> model) throws Exception {
		...
		createTab(model, new IEntityTabBuilder<IDocument>() {
			...
			public EntityPanel<IDocument> buildTabPanel(
					IModel<IDocument> entity, String panelId) {
				return new ContactSectionDataPanel(panelId, entity);
			}
		});
		...
		createTab(model, new IEntityTabBuilder<IDocument>() {
			...
			public String getTabLabel(IModel<IDocument> entity) {
				return "Dane geograficzne";
			}

			public EntityPanel<IDocument> buildTabPanel(
					IModel<IDocument> entity, String panelId) {
				return new GisDataPanel(panelId, entity);
			}
		});

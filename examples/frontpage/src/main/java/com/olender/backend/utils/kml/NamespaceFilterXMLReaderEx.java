...
public class NamespaceFilterXMLReaderEx implements XMLReader {

	private XMLReader xmlReader;

	public NamespaceFilterXMLReaderEx(boolean validate)
	...
	public void setContentHandler(ContentHandler handler) {
		xmlReader.setContentHandler(new NamespaceFilterHandlerEx(handler));
	}
